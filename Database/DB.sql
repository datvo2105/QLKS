...
CREATE TABLE BOOKING (
    ...
    BOOKING_ROOM_KEY VARCHAR2(500) NOT NULL,
    USERNAME VARCHAR(50),
    ROOM_ID NUMBER,
...
CREATE TABLE STATISTICAL(
    STATISTICAL_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
/
//========================================================================================
SELECT * FROM ROOM WHERE ROOM.ROOM_NAME LIKE '%' || '' || '';