...
public class Receipt {
	...
	public List<BLL.Receipt> getAllReceipt(String search) {
		sql = "SELECT R.* FROM DEV.RECEIPT R JOIN DEV.BOOKING B ON R.BOOKING_ID = B.BOOKING_ID WHERE B.USERNAME LIKE ? ";
